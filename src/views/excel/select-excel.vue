  ...
  <div class="container">
    ...
    <div class="table-container">
      <el-table :data="movieList" style="width: 100%">
        <el-table-column prop="actorName" label="演员" :width="500" />
        <el-table-column prop="directorName" label="导演" :width="500" />
...
export default {
  ...
  methods: {
    ...
    fetchMoviesFromMySQL() {
      return this.$axios.get('/api/db1/movies/cooperationad').then(res => res.data)
    },

    fetchMoviesFromHive() {
      return this.$axios.get('/api/db2/movies/cooperationad').then(res => res.data)
    },

    fetchMoviesFromNeo4j() {
      return this.$axios.get('/api/db3/movies/cooperationad').then(res => res.data)
    }
  }
}
</script>
