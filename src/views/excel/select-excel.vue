...
export default {
  ...
  methods: {
    ...
    fetchMoviesFromMySQL() {
      ...
      var config = {
        method: 'get',
        url: 'http://localhost:8080/api/db1/movies/cooperationad',
        params: {},
        headers: {}
      }
      return axios(config)
    ...
    fetchMoviesFromHive() {
      ...
      var config = {
        method: 'get',
        url: 'http://localhost:8081/api/db2/movies/cooperationad',
        params: {},
        headers: {}
      }
      return axios(config)
    ...
    fetchMoviesFromNeo4j() {
      ...
      var config = {
        method: 'get',
        url: 'http://localhost:8082/api/db3/movies/cooperationad',
        params: {},
        headers: {}
      }
      return axios(config)
